  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-[#1e293b] mb-2">Contact Form Submissions</h1>
          <p className="text-gray-600">Messages from the contact page</p>
        </div>
        <button
      ...
      <div className="space-y-4">
        {filteredSubmissions.length === 0 ? (
          <div className="bg-white rounded-xl shadow-lg p-12 text-center">
            ...
            <p className="text-xl text-gray-600">No contact submissions found</p>
          </div>
        ) : (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                {submission.company && (
                  <div>
                    ...
                    <p className="font-semibold text-[#1e293b]">{submission.company}</p>
                  </div>
                )}
                <div>
