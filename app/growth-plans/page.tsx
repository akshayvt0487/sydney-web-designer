      ...
      <section className="py-20">
        <div className="container">
          ...
          <div className="space-y-8 max-w-5xl mx-auto">
            ...
            <div className="card hover:shadow-card-hover transition-all">
              <div className="flex flex-col lg:flex-row gap-6">
                <div className="lg:w-1/3">
                  <h3 className="text-2xl font-bold mb-2 text-primary-navy">Website Care</h3>
                  <div className="text-3xl font-bold text-primary-orange mb-2">$250/month</div>
                  <p className="text-gray-600 mb-2">+ GST</p>
                  <p className="text-sm text-gray-500">Keep your website secure and updated</p>
                </div>
            ...
            {/* Website Care & CRM */}
            <div className="card hover:shadow-card-hover transition-all border-2 border-primary-orange">
              <div className="flex flex-col lg:flex-row gap-6">
                <div className="lg:w-1/3">
                  <h3 className="text-2xl font-bold mb-2 text-primary-navy">Website Care & CRM</h3>
                  <div className="text-3xl font-bold text-primary-orange mb-2">$500/month</div>
                  <p className="text-gray-600 mb-2">+ GST</p>
                  <p className="text-sm text-gray-500">Website care + customer management</p>
                </div>
                <div className="lg:w-2/3">
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="flex items-start gap-2">
            ...
            <div className="card hover:shadow-card-hover transition-all border-4 border-primary-orange relative">
              <div className="absolute -top-4 left-8 bg-primary-orange text-white px-6 py-1 rounded-full text-sm font-bold">
                Popular
              </div>
              <div className="flex flex-col lg:flex-row gap-6">
                <div className="lg:w-1/3">
                  <h3 className="text-2xl font-bold mb-2 text-primary-navy">Paid Ads Management</h3>
                  <div className="text-3xl font-bold text-primary-orange mb-2">$1,000/month</div>
                  <p className="text-gray-600 mb-2">+ GST + Ad Spend</p>
                  <p className="text-sm text-gray-500">Google OR Facebook Ads management</p>
                </div>
                <div className="lg:w-2/3">
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="flex items-start gap-2">
            ...
            <div className="card hover:shadow-card-hover transition-all">
              <div className="flex flex-col lg:flex-row gap-6">
                <div className="lg:w-1/3">
                  <h3 className="text-2xl font-bold mb-2 text-primary-navy">SEO Package</h3>
                  <div className="text-3xl font-bold text-primary-orange mb-2">$3,000/month</div>
                  <p className="text-gray-600 mb-2">+ GST</p>
                  <p className="text-sm text-gray-500">Complete SEO & content marketing</p>
                </div>
                <div className="lg:w-2/3">
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="flex items-start gap-2">
            ...
            <div className="card hover:shadow-card-hover transition-all bg-[#1e293b] text-white">
              <div className="flex flex-col lg:flex-row gap-6">
                <div className="lg:w-1/3">
                  ...
                  <h3 className="text-2xl font-bold mb-2 text-white">Complete Marketing</h3>
                  <div className="text-3xl font-bold text-white mb-2">$5,000 - $10,000/month</div>
                  <p className="text-gray-100 mb-2">+ GST + Ad Spend</p>
                  <p className="text-sm text-gray-200">Everything you need to dominate</p>
                </div>
                <div className="lg:w-2/3">
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="flex items-start gap-2">
