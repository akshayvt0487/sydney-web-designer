  ...
  return (
    <>
      ...
      <section className="bg-[#1e293b] text-white py-20">
        <div className="container">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl font-bold mb-6 text-white">Content Marketing That Establishes Authority</h1>
            <p className="text-xl text-white mb-8">Create valuable content that attracts, engages, and converts your audience. Establish authority and drive customer action with strategic content marketing.</p>
      ...
      <section className="py-20">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-4xl md:text-6xl font-bold text-center text-[#1e293b] mb-4">Complete Content Marketing <span className="text-[#f59e0b]">Services</span></h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-4xl md:text-6xl font-bold text-center text-[#1e293b] mb-4">Our Content Marketing <span className="text-[#f59e0b]">Process</span></h2>
