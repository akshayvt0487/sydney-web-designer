    ...
    <>
      ...
      <section className="bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] text-white py-32 relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          ...
          <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-[#ec4899] rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000" />
        </div>
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-[#f59e0b]/10 border border-[#f59e0b]/30 rounded-full px-5 py-2 mb-8 backdrop-blur-sm">
              ...
              <span className="text-[#f59e0b] text-sm font-semibold">Digital PR Specialists</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
              Digital PR Sydney
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-slate-100">
              Earn media coverage, authoritative backlinks, and brand awareness. Strategic digital PR that amplifies your SEO and reputation.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 max-w-3xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-sm text-slate-300">Media Mentions</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-[#f59e0b] mb-2">DR 60+</div>
                <div className="text-sm text-slate-300">Avg Link Authority</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-[#f59e0b] mb-2">840%</div>
                <div className="text-sm text-slate-300">Brand Search Growth</div>
              </div>
              <div className="text-center">
