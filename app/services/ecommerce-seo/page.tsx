  ...
  return (
    <>
      ...
      <ServiceHeroSection
        ...
        heading="Ecommerce SEO Sydney"
        description="Rank your products higher. Drive more sales. Grow your online store with proven ecommerce SEO strategies."
        buttons={{
          primary: {
        ...
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">To Major Results</div>
            </div>
          </div>
        </div>
      </section>
