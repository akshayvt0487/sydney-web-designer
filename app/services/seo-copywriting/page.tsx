  ...
  return (
    <>
      ...
      <ServiceHeroSection
        ...
        heading="SEO Copywriting Sydney"
        description="Content that ranks on Google and converts visitors into customers. Strategic SEO copywriting for Sydney businesses."
        buttons={{
          primary: {
